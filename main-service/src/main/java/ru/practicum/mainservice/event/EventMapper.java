...
//    // Для EventDtoShort только ID
//    @Mapping(target = "category", source = "category")
//    @Mapping(target = "initiator", source = "initiator")
//    @Mapping(target = "views", ignore = true)
//    EventDtoShort toEventShortDto(Event event);
//
//    // Для EventDtoFull DTO объекты
//    @Mapping(target = "category", expression = "java(mapCategoryToDto(event.getCategory()))")
//    @Mapping(target = "initiator", expression = "java(mapUserToDto(event.getInitiator()))")
//    @Mapping(target = "location", expression = "java(mapLocationToDto(event.getLocation()))")
//    @Mapping(target = "views", ignore = true)
//    EventDtoFull toEventFullDto(Event event);
//
//    @Mapping(target = "category", expression = "java(mapLongToCategory(eventDto.getCategory()))")
//    @Mapping(target = "initiator", expression = "java(mapLongToUser(eventDto.getInitiator()))")
//    @Mapping(target = "location", expression = "java(mapLocationDtoToLocation(eventDto.getLocation()))")
//    @Mapping(target = "state", ignore = true)
//    @Mapping(target = "createdOn", ignore = true)
//    @Mapping(target = "publishedOn", ignore = true)
//    @Mapping(target = "confirmedRequests", ignore = true)
...
//    @Mapping(target = "publishedOn", ignore = true)
//    @Mapping(target = "confirmedRequests", ignore = true)
//    void updateSimpleFieldsFromDto(EventDto eventDto, @MappingTarget Event event);
//
//    // Методы для EventDtoFull (возвращают полноценные DTO)
//    default CategoryDto mapCategoryToDto(Category category) {
//        if (category == null) {
//            return null;
//        }
//        return ru.practicum.mainservice.category.CategoryDto.builder()
//                .id(category.getId())
//                .name(category.getName())
//                .build();
//    }
...
//    }
//
//    default Location mapLocationDtoToLocation(LocationDto locationDto) {
//        if (locationDto == null) {
//            return null;
//        }
//        return Location.builder()
...
//
//
//        default void onUpdateEventFromDto(EventDto eventDto, Event event) {
//
